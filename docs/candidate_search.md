...
Next: independently reproduce CASE1/CASE2 retrieval, define its grouping/count
assertions and extend supported evidence/methods incrementally. Formal duplication
rules remain a separate layer.
